...
export const demoSamples: DemoSample[] = [
  {
    ...
    markdown: [
      ...
      '- [[Project Notes#Project Notes#Overview#Detail|Nested heading target]]',
      '- [[Roadmap#^next-step|Next milestone block]]',
      '',
      '## Fragment notes',
      '',
      '- Repeated `#` stays inside one fragment, so [[Project Notes#Project Notes#Overview#Detail]] targets a nested heading path.',
  ...
  },
  {
    ...
    markdown: [
      ...
      '| Embeds | Stable | ![[Project Notes#Project Notes#Overview#Detail]] | Nested note embeds reuse the same markdown pipeline. |',
...
export const demoWikiPages: DemoWikiPage[] = [
  ...
  },
  {
    ...
    markdown: [
      ...
      '### Detail',
      '',
      'This nested heading is the destination for [[Project Notes#Project Notes#Overview#Detail]] and `![[Project Notes#Project Notes#Overview#Detail]]`.',
      '',
